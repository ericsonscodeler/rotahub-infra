...
>
> Repositórios: `orders-service`, `tracking-service`, `rotahub-bff`, `rotahub-web`, `rotahub-infra`.
...
| GET | `/api/orders` | Lista combinada paginada |
...
Roteirização, Notificações, microfrontends federados, React Native, API Gateway,
